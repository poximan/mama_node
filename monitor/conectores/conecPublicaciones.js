var ip = require("../../propiedades.json").monitor.ip_publicaciones;
var port = require("../../propiedades.json").monitor.port_publicaciones;
...
function esValido(comando){
  ...
  console.log("ServPublicaciones: comando \"" + comando + "\" -->", (coincidencia?"valido":"invalido"));
  return coincidencia;
}
